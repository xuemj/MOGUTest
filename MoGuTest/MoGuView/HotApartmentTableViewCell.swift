//
//  HotApartmentTableViewCell.swift
//  MoGuTest
//
...
import UIKit
typealias sendBlack = (_ index :Int)->Void
class HotApartmentTableViewCell: UITableViewCell {
    @IBOutlet weak var scView: UIScrollView!
    var sendblack: sendBlack?
